...
{{end}}
	...
	<tr><th>时间</th><th>IP</th><th>Key</th><th>Method</th><th>Host</th><th>Status</th><th>耗时</th><th>流式</th><th>输入</th><th>缓存</th><th>输出</th><th>命中率</th><th>输入费用</th><th>输出费用</th><th>总费用</th></tr>
	{{range .}}
	<tr>
